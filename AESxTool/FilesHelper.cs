...
namespace AESxTool
{
    ...
    {
        public static void EncryptFile(this string path,string password)
        {
            SharpAESCrypt.Core.SharpAESCrypt.Encrypt(password, path, path + ".aes");
        }
        ...
        public static void EncryptFiles(this IEnumerable<string> paths, string password)
        {
            foreach (var path in paths)
            {
                path.EncryptFile(password);
            }
        }
        ...
        public static async Task DecryptFileAsync(this string path, string password)
        {
            ...
            await Task.Run(() =>
            {
                ...
                SharpAESCrypt.Core.SharpAESCrypt.Decrypt(password, path, outputpath);
            });
        }
